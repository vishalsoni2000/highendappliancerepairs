/* https://herostencilscss.agvnt68s-liquidwebsites.com/wp-content/themes/herostencil/js/jquery.cookie.js */
try{
...
/* https://herostencilscss.agvnt68s-liquidwebsites.com/wp-content/themes/herostencil/js/slick.min.js */
try{
/*
     _ _      _       _
 ___| (_) ___| | __  (_)___
...
/* https://herostencilscss.agvnt68s-liquidwebsites.com/wp-content/themes/herostencil/js/jquery.matchheight.min.js */
try{
/*
...
/* https://herostencilscss.agvnt68s-liquidwebsites.com/wp-content/themes/herostencil/js/jquery.fancybox.min.js */
try{
// ==================================================
// fancyBox v3.5.6
//
...
return!1});$('.location-therapists-section ul.staff-list').slick({infinite:!0,slidesToShow:2,slidesToScroll:1,dots:!1,arrows:!0,autoplay:!0,adaptiveHeight:!0,nextArrow:'<span class="slick-next"> &#10095; </span>',prevArrow:'<span class="slick-prev"> &#10094; </span>',responsive:[{breakpoint:580,settings:{slidesToShow:1,slidesToScroll:1}}]});$('.testimonial-slide').slick({infinite:!0,slidesToShow:1,slidesToScroll:1,autoplay:!0,dots:!1,arrows:!0,adaptiveHeight:!0,nextArrow:'<span class="slick-next"> &#10095; </span>',prevArrow:'<span class="slick-prev"> &#10094; </span>',});$('.testimonial-post .slider-post').slick({infinite:!1,slidesToShow:1,dots:!0,autoplay:!1,responsiveClass:!0,arrows:!1,});if($('.run-slider').length>0){if($('.home__single--slide').length>1){$('.home-slider').on('init',function(event,slick){$('.slick-current ').find('.home__single--slide-content').addClass(' show ')});$('.home-slider').slick({arrows:!0,nextArrow:'<span class="slick-next"> &#10095; </span>',prevArrow:'<span class="slick-prev"> &#10094; </span>',dots:!0,autoplay:!1,adaptiveHeight:!0,autoplaySpeed:6000,});jQuery('.home-slider').on('beforeChange',function(slick,slide,current){$('.slick-slide ').find('.home__single--slide-content').removeClass(' show ');$('.slick-slide ').find('.home__single--slide-content').addClass(' hide ')});jQuery('.home-slider').on('afterChange',function(slick,slide,current){$('.slick-current ').find('.home__single--slide-content').addClass(' show ')})}else{setTimeout(function(){$('.home-slider').find('.home__single--slide-content').addClass(' show ')},1000)}}else{if($('.home-slider').find('.home__single--slide-content').hasClass('mobile-show')){setTimeout(function(){$('.home-slider').find('.home__single--slide-content').addClass(' show ')},1000)}}
$('#searchform').submit(function(){if($('#s').val()==''){return!1}});$(document).on('click','.quick-not-closer',function(){cookieName=$(this).prev('h5').text();cookieNameNew=cookieName.split(' ').join('_');$.cookie(cookieNameNew,1,{expires:1});$('.quick-notes').slideUp(500);setTimeout(function(){$headerHeight=jQuery('header').outerHeight();jQuery('#wrapper').css('padding-top',$headerHeight)},500)})});jQuery(window).on('load resize ready',function($){setTimeout(function(){$headerHeight=jQuery('header').outerHeight();jQuery('#wrapper').css('padding-top',$headerHeight)},500);if(jQuery(window).scrollTop()>50){setTimeout(function(){stickyHeader()},500)}});jQuery(window).scroll(function(event){stickyHeader()});(function($){$(window).on("load",function(){if($('.review-sidebar').length>0){var v_feed_fun=setInterval(function(){var v_feed=$('.v-feed').length
if(v_feed>0){myStopFunction();$(".review-sidebar").mCustomScrollbar({theme:"rounded-dark"})}},2000);function myStopFunction(){clearInterval(v_feed_fun)}}})})(jQuery);function stickyHeader(){var sticky=jQuery('header'),scroll=jQuery(window).scrollTop();if(scroll>=50){sticky.addClass('sticky');$headerHeightscroll=jQuery('header.sticky').outerHeight()}else sticky.removeClass('sticky')}
...
jQuery(document).ready(function($){var i=1;var siteurl=frontend_ajax_object.siteurl;$('.custom-location-map').each(function(index,currentElement){$(this).attr('id','map'+i);var load_id='map'+i;var lat=$(this).attr('loc_lat');var long=$(this).attr('loc_long');var address=$(this).attr('loc_address');var mapURL=$(this).attr('loc_map-url');var latlng=new google.maps.LatLng(lat,long);var options={zoom:16,center:latlng,scrollwheel:!1,mapTypeId:google.maps.MapTypeId.TERRAIN,};var map=new google.maps.Map(document.getElementById(load_id),options);var image=new google.maps.MarkerImage(siteurl+'/images/map-pin.png',new google.maps.Size(50,67),new google.maps.Point(0,0),new google.maps.Point(25,67));var marker1=new google.maps.Marker({position:latlng,map:map,icon:image});function createInfo(title,content){return'<div class="infowindow"><a target="_blank" href="'+mapURL+'"><strong>'+address+'</strong></a></div>'}
var infowindow1=new google.maps.InfoWindow({content:createInfo('Get Direction')});google.maps.event.addListener(marker1,'click',function(){infowindow1.open(map,marker1)});$(window).resize(function(){google.maps.event.trigger(map,"resize")});i++})});jQuery('.staff-location-list li a').on('click',function(){jQuery('.masonary-list li a').removeClass('current');jQuery(this).addClass("current");var location_id=jQuery(this).attr('id');data={'action':'location_staff_filter','staff_loc':location_id,};jQuery.ajax({url:frontend_ajax_object.ajax_url,data:data,type:'POST',success:function(data){jQuery('.page-staff-loaction-designation').html('');jQuery('.page-staff-loaction-designation').append(data)},complete:function(){}});return!1});

}
catch(e){console.error("An error has occurred: "+e.stack);}
/* https://herostencilscss.agvnt68s-liquidwebsites.com/wp-content/plugins/a3-lazy-load/assets/js/jquery.lazyloadxt.extra.min.js */
try{
...
/* https://herostencilscss.agvnt68s-liquidwebsites.com/wp-content/plugins/a3-lazy-load/assets/js/jquery.lazyloadxt.srcset.min.js */
try{
/* Lazy Load XT 1.1.0 | MIT License */
...
/* https://herostencilscss.agvnt68s-liquidwebsites.com/wp-content/plugins/a3-lazy-load/assets/js/jquery.lazyloadxt.extend.js */
try{
...
/* https://herostencilscss.agvnt68s-liquidwebsites.com/wp-includes/js/wp-embed.min.js */
try{
...
/* https://herostencilscss.agvnt68s-liquidwebsites.com/wp-content/plugins/ninja-forms-uploads/assets/js/lib/jquery.iframe-transport.js */
try{
...
/* https://herostencilscss.agvnt68s-liquidwebsites.com/wp-includes/js/jquery/ui/widget.min.js */
try{
/*!
...
/* https://herostencilscss.agvnt68s-liquidwebsites.com/wp-content/plugins/ninja-forms-uploads/assets/js/lib/jquery.fileupload.js */
try{
...
/* https://herostencilscss.agvnt68s-liquidwebsites.com/wp-content/plugins/ninja-forms-uploads/assets/js/lib/jquery.fileupload-process.js */
try{
...
/* https://herostencilscss.agvnt68s-liquidwebsites.com/wp-content/plugins/ninja-forms-uploads/assets/js/lib/jquery.fileupload-validate.js */
try{
...
/* https://herostencilscss.agvnt68s-liquidwebsites.com/wp-includes/js/underscore.min.js */
try{
...
/* https://herostencilscss.agvnt68s-liquidwebsites.com/wp-includes/js/backbone.min.js */
try{
...
/* https://herostencilscss.agvnt68s-liquidwebsites.com/wp-content/plugins/ninja-forms/assets/js/min/front-end-deps.js */
try{
/*!
 * Includes BabySitter
...
/* https://herostencilscss.agvnt68s-liquidwebsites.com/wp-content/plugins/ninja-forms/assets/js/min/front-end.js */
try{
...
/* https://herostencilscss.agvnt68s-liquidwebsites.com/wp-content/plugins/ninja-forms-uploads/assets/js/front-end/controllers/fieldFile.js */
try{
...
return!0},showError:function(error,view){nfRadio.channel('fields').request('add:error',view.model.id,'upload-file-error',error)},isNonceValid(view){var nonceExpiry=view.model.get('uploadNonceExpiry');if(typeof nonceExpiry==='undefined'||nonceExpiry===null){return!1}
var now=Math.round((new Date()).getTime()/1000);return now<nonceExpiry},getValidNonce(field_id){return jQuery.post({url:nfFrontEnd.adminAjax+'?action=nf_fu_get_new_nonce',type:'POST',data:{'field_id':field_id},cache:!1})},initFileUpload:function(view){var fieldID=view.model.id;var formID=view.model.get('formID');var nonce=view.model.get('uploadNonce');var $file=$(view.el).find('.nf-element');var $files_uploaded=$(view.el).find('.files_uploaded');this.$progress_bars[fieldID]=$(view.el).find('.nf-fu-progress-bar');var url=nfFrontEnd.adminAjax+'?action=nf_fu_upload';var self=this;var files=view.model.get('files');files=files||[];if(!(files instanceof FileCollection)){files=new FileCollection(files);view.model.set('files',files)}
this.renderView(view);var formData={form_id:formID,field_id:fieldID,nonce:nonce};$file.fileupload({url:url,dataType:'json',messages:{maxFileSize:nf_upload.strings.max_file_size_error.replace('%n',view.model.get('max_file_size_mb')),minFileSize:nf_upload.strings.min_file_size_error.replace('%n',view.model.get('min_file_size_mb'))},singleFileUploads:!1,maxFileSize:view.model.get('max_file_size'),minFileSize:view.model.get('min_file_size'),add:function(e,data){data.formData=formData;if(self.isNonceValid(view)){data.submit();return}
...
view.model.set('uploadNonce',response.data.nonce);view.model.set('uploadNonceExpiry',response.data.nonce_expiry);data.formData.nonce=response.data.nonce;data.submit()})},change:function(e,data){if(!self.checkFilesLimit(view,e,data)){return!1}
